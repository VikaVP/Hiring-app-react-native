          ...
          <View style={{backgroundColor: 'white', flex: 1}}>
            {!isLoading ? (
              <View
                ...
                <Bubbles size={10} style={{marginTop: 500}} color="green" />
              </View>
            ) : (
                  ...
                  <TouchableOpacity
                    ...
                    <View
                      ...
                      <Icon2
                        name="photo-camera"
                        size={100}
                        style={{top: -200, left: 120, color: 'white'}}
                      />
                    </View>
                  </TouchableOpacity>
                  <View style={{marginTop: -90}}>
                    <Text style={{fontSize: 10, color: 'gray'}}>
                      note: Make sure the uploaded image is less than 2 mb
                    </Text>
                  </View>
                  <View>
                    <Text>{fileName}</Text>
                    ...
                    <View style={{flex: 1, alignItems: 'center'}}>
                      {photoErr ? (
                        <Button
                          disabled
                          onPress={() =>
                            alert('Cannot submit if photo is wrong')
                          }
                          style={{width: 100}}>
...
const mapDispatchToProps = dispatch => ({
  ...
  fetchUpdate: (id, data, config) =>
    dispatch(fetchUpdateCompanies(id, data, config)),
});
export default connect(
  mapStateToProps,
  mapDispatchToProps,
)(withNavigation(EditPhotoCompanies));
