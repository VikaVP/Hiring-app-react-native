...
import EditPhotoCompany from '../components/EditPhotoCompanies'
class EditPhotoCompanies extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            isLoading: false,
        ...
        return (
            <View style={style.ListCompanies}>
                <ScrollView style={{ flex: 1, marginTop: -15 }}>
                    <EditPhotoCompany prop={companies} />
                </ScrollView>
...
export default withNavigation(EditPhotoCompanies)
